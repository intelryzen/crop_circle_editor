...
class CropRotateEditorWidgets
    extends CustomWidgetsStandaloneEditor<CropCircleEditorState> {
  ...
  /// aspect ratios.
  final CropEditorAspectRatioOptions<CropCircleEditorState>? aspectRatioOptions;

  @override
  CropRotateEditorWidgets copyWith({
    ReactiveAppbar? Function(
            CropCircleEditorState editorState, Stream<void> rebuildStream)?
        appBar,
    ReactiveWidget? Function(
            CropCircleEditorState editorState, Stream<void> rebuildStream)?
        bottomBar,
    CustomBodyItems<CropCircleEditorState>? bodyItems,
    CropEditorAspectRatioOptions<CropCircleEditorState>? aspectRatioOptions,
  }) {
