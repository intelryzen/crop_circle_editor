...
/// provided parameters.
class CropCircleEditor extends StatefulWidget
  ...
  factory CropCircleEditor.memory(
    Uint8List byteArray, {
    Key? key,
    required CropRotateEditorInitConfigs initConfigs,
  }) {
    return CropCircleEditor._(
      key: key,
  ...
  factory CropCircleEditor.asset(
    String assetPath, {
    Key? key,
    required CropRotateEditorInitConfigs initConfigs,
  }) {
  ...
  /// network URL.
  factory CropCircleEditor.network(
    String networkUrl, {
    Key? key,
    required CropRotateEditorInitConfigs initConfigs,
  }) {
  ...
  factory CropCircleEditor.autoSource({
    Key? key,
    Uint8List? byteArray,
    File? file,
    String? assetPath,
    ...
    if (byteArray != null || editorImage?.byteArray != null) {
      return CropCircleEditor.memory(
      ...
      return CropCircleEditor.network(
...
class CropCircleEditorState extends State<CropCircleEditor>
    with
        TickerProviderStateMixin,
        ImageEditorConvertedConfigs,
        ImageEditorConvertedCallbacks,
        StandaloneEditorState<CropCircleEditor, CropRotateEditorInitConfigs>,
        ExtendedLoop,
        CropAreaHistory {
